...
public class ProxyBuilderTest extends AbstractTest {
    ...
    public void nonInterfaceTypeProvided() {
        validateExceptionMessage("'class com.dataspecks.proxy.core.ProxyBuilder' can only be created for interfaces. 'com.dataspecks.proxy.core.ProxyBuilderTest' is not an interface",
